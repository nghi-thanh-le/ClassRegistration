    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <p class="lead text-warning">Please make the desired changes and click Update</p>
          <?php
            if(isset($_SESSION["errmsg"])){
              if($_SESSION["errmsg"] == 1){
          ?>
            <p class="text-danger">A Class Title is required.</p>
            <p class="text-danger">Please RE-make the desired changes and click Update</p>
          <?php
              }
          ...
          ?>
          <!-- Class entry form -->
          <form action="updateclass.php?recordID=<?= $classid; ?>" method="post" class="form-horizontal">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="class_title" value="<?= $classrow['class_title']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="class_start" class="col-lg-2 control-label">Class Start Date<span style="color: red;">*</span>:</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="class_start" value="<?= $classrow['class_start']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="class_descr" class="col-lg-2 control-label">Class Description:</label>
                <div class="col-lg-10">
                  <textarea class="form-control" rows="4" name="class_descr"><?= $classrow['class_descr']; ?></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-2">
                  <input type="text" class="form-control" name="class_cost" value="<?= $classrow['class_cost']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="class_instr" class="col-lg-2 control-label">Class Instructor:</label>
                <div class="col-lg-2">
                  <input type="text" class="form-control" name="class_instr" value="<?= $classrow['class_instr']; ?>">
                </div>
              </div>
              <div class="form-group">
